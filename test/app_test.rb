...
class AppTest < Minitest::Test
  ...
  def test_renders_discord_like_scrolling_shell
    Dir.mktmpdir do |dir|
      ...
      assert_includes response.body, "body:not(.is-conversation-scrolling) .jump-controls.is-visible { display: none; }"
      assert_includes response.body, "function revealConversationJumpControlsTemporarily()"
      assert_includes response.body, "revealConversationJumpControlsTemporarily();"
